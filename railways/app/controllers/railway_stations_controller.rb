class RailwayStationsController < ApplicationController
  ...
  def create
    ...
    @railway_station.save ? redirect_to(@railway_station, notice: 'Railway station was successfully created.') : render(:new)
  end
  ...
  private
    ...
    def position_params
      params.require(:railway_station).permit(:route_id, :position)
    end
end
