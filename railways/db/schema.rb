...
ActiveRecord::Schema.define(version: 20160819150617) do
  ...
  add_index "coaches", ["id", "type"], name: "index_coaches_on_id_and_type", using: :btree
  add_index "coaches", ["train_id"], name: "index_coaches_on_train_id", using: :btree
